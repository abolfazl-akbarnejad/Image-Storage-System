...
class ImageService extends ImageToolsService
{
    ...
    public function compress($image, $quality)
    {
        ...
        $this->provider();
        //save image
        $result = Image::make($image->getRealPath())->save(public_path($this->getImageAddress()), $quality, $this->getImageFormat());
        return $result ? $this->getImageAddress() : false;
    }

    public function fitandCompress($image, $width, $height, $quality)
    {
        ...
        $this->provider();
        //save image
        $result = Image::make($image->getRealPath())->fit($width, $height)->save(public_path($this->getImageAddress()), $quality, $this->getImageFormat());
        return $result ? $this->getImageAddress() : false;
    }
